        ...
        return a.each(function () {
            ...
            (m = {
                preinitialize: function () {
                    m.is.dimmer() ? (f = S.parent(), d = S) : (f = S, d = m.has.dimmer() ? g.dimmerName ? f.find(p.dimmer).filter("." + g.dimmerName) : f.find(p.dimmer) : m.create())
                }, initialize: function () {
                    ...
                    }, m.debug("Showing dimmer", d, g), m.set.variation(), m.is.dimmed() && !m.is.animating() || !m.is.enabled() ? m.debug("Dimmer is already shown or disabled") : (m.animate.show(t), g.onShow.call(k), g.onChange.call(k))
                }, hide: function (t) {
                    t = e.isFunction(t) ? t : function () {
                    ...
                    show: function (t) {
                        t = e.isFunction(t) ? t : function () {
                        }, g.useCSS && e.fn.transition !== i && d.transition("is supported") ? (g.useFlex ? (m.debug("Using flex dimmer"), m.remove.legacy()) : (m.debug("Using legacy non-flex dimmer"), m.set.legacy()), "auto" !== g.opacity && m.set.opacity(), d.transition({
                        ...
                        t = e.isFunction(t) ? t : function () {
                            ...
                            onComplete: function () {
                                m.remove.variation(), m.remove.active(), t()
                            }
                ...
                initialize: function () {
                    ...
                    var i = {
                        ...
                        onSuccess: function (t) {
                            ...
                            e.isArray(i) && i.length > 0 ? (S.remove.message(), S.setup.menu({values: t[R.remoteValues]})) : S.add.message(A.noResults), n()
                        }
                    };
                    ...
                    change: function () {
                        ...
                        click: function (e) {
                            W.hasClass(T.clear) ? S.clear() : S.toggle()
                        }
                    }, text: {
                        focus: function (e) {
                            $ = !0, S.focusSearch()
                    ...
                    nothing: function () {
                        ...
                        S.set.value(n, t, e(i)), S.hideAndClear()
                    }
                }, get: {
                    id: function () {
                        return x
                    ...
                    filtered: function () {
                        ...
                        S.is.single() && k.clearable && (o ? S.set.clearable() : S.remove.clearable()), !1 === k.fireOnInit && S.is.initialLoad() ? S.verbose("No callback on initial load", k.onChange) : k.onChange.call(K, e, t, n)
                    }, active: function () {
                        M.addClass(T.active)
                    }, multiple: function () {
        ...
        return r.each(function () {
            ...
            k = {
                initialize: function () {
                    ...
                    k.remove.scrolling(), k.cacheSizes(), k.can.useFlex() || k.set.modalOffset(), k.set.screenHeight(), k.set.type()
                    ...
                    events: function () {
                        ...
                        y.get(0).addEventListener("touchmove", k.event.preventScroll, {passive: !1})
                    }
                }, unbind: {
                    scrollLock: function () {
                        y.get(0).removeEventListener("touchmove", k.event.preventScroll, {passive: !1})
                    }
                }, get: {
                    id: function () {
                    ...
                    t = e.isFunction(t) ? t : function () {
                    }, k.refreshModals(), k.set.dimmerSettings(), k.set.dimmerStyles(), k.showModal(t)
                }, hide: function (t) {
                    t = e.isFunction(t) ? t : function () {
                    }, k.refreshModals(), k.hideModal(t)
                }, showModal: function (t) {
                    t = e.isFunction(t) ? t : function () {
                    }, k.is.animating() || !k.is.active() ? (k.showDimmer(), k.cacheSizes(), k.can.useFlex() ? k.remove.legacy() : (k.set.legacy(), k.set.modalOffset(), k.debug("Using non-flex legacy modal positioning.")), k.set.screenHeight(), k.set.type(), k.set.clickaway(), !T.allowMultiple && k.others.active() ? k.hideOthers(k.showModal) : (T.allowMultiple && T.detachable && D.detach().appendTo(x), T.onShow.call(z), T.transition && e.fn.transition !== i && D.transition("is supported") ? (k.debug("Showing modal with css animations"), D.transition({
                        debug: T.debug,
                    ...
                    t = e.isFunction(t) ? t : function () {
                        ...
                        onComplete: function () {
                            T.onHidden.call(z), k.remove.dimmerStyles(), k.restore.focus(), t()
                        }
                    ...
                    y.dimmer("is animating") || y.dimmer("is active") ? (k.unbind.scrollLock(), y.dimmer("hide", function () {
                    ...
                    active: function () {
                        ...
                        D.removeClass(R.legacy)
                    }, clickaway: function () {
                        x.off("click" + C)
                    }, dimmerStyles: function () {
                        x.removeClass(R.inverted), y.removeClass(R.blurring)
                    }, bodyStyle: function () {
                    ...
                    var o = D.prop("scrollHeight"), a = D.outerWidth(), r = D.outerHeight();
                    k.cache !== i && 0 === r || (k.cache = {
                    ...
                    useFlex: function () {
                        return "auto" == T.useFlex ? T.detachable && !k.is.ie() : T.useFlex
                    }, fit: function () {
                    ...
                    autofocus: function () {
                        ...
                        if (e.fn.dimmer !== i) {
                            ...
                            T.inverted && (n.variation = n.variation !== i ? n.variation + " inverted" : "inverted"), q.dimmer("setting", n)
                        } else k.error(E.dimmer)
                    }, dimmerStyles: function () {
                        T.inverted ? x.addClass(R.inverted) : x.removeClass(R.inverted), T.blurring ? y.addClass(R.blurring) : y.removeClass(R.blurring)
                    }, modalOffset: function () {
                        var e = k.cache.width, t = k.cache.height;
                        D.css({
                            marginTop: T.centered && k.can.fit() ? -t / 2 : 0,
                            marginLeft: -e / 2
                        ...
                        y.addClass(R.scrolling), D.addClass(R.scrolling), k.unbind.scrollLock()
                    }, legacy: function () {
                        D.addClass(R.legacy)
                    }, type: function () {
                        k.can.fit() ? (k.verbose("Modal fits on screen"), k.others.active() || k.others.animating() || (k.remove.scrolling(), k.bind.scrollLock())) : (k.verbose("Modal cannot fit on screen setting to scrolling"), k.set.scrolling())
                    }, undetached: function () {
            ...
            x = {
                initialize: function () {
                    ...
                    events: function () {
                        ...
                        (!0 === C.hideOnScroll || "auto" == C.hideOnScroll && "click" != C.on) && x.bind.closeOnScroll(), x.is.closable() ? x.bind.clickaway() : "hover" == C.on && I && x.bind.touchClose()
